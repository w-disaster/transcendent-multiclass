...
def main():
    ...
    (
        time_series_p_val_results,
        time_series_p_vals,
        p_val_keep_masks,
        time_series_proba_results,
        time_series_probas,
        proba_keep_masks,
    ) = [], [], [], [], [], []
    ...
    if args.thresholds == "quartiles":
        ...
        raise ValueError("Unknown option: args.thresholds = {}".format(args.threshold))

    data.save_results(report_str, args)

    data.cache_data(
        time_series_p_val_results, "timeseries_cred_conf/ice_p_val_results.p"
    )
    ...
    data.cache_data(
        time_series_proba_results, "timeseries_cred_conf/ice_proba_results.p"
    )
