...
class Main:
    ...
    def process_data(self):
        ...
        for i in range(slice_train):
            if (
                1514678400 > x_train[i][timestamp_position] > 1483228800
                and y_train[i] != -1.0
            ):
        ...
        for i in range(slice_test):
            if (
                1514678400 > x_test[i][timestamp_position] > 1483228800
                and y_test[i] != -1.0
            ):
    ...
    def plot(self):
        ...
        svc_aut = [
            metrics.aut(svc_results, "f1"),
            metrics.aut(svc_results, "precision"),
            metrics.aut(svc_results, "recall"),
        ]
        rfc_aut = [
            metrics.aut(rfc_results, "f1"),
            metrics.aut(rfc_results, "precision"),
            metrics.aut(rfc_results, "recall"),
        ]
